...
('Senior Teller', 'SENIOR_MAKER', '["FORM_CREATE","FORM_SUBMIT","FORM_VIEW_OWN","APPROVE_TIER1","QUEUE_VIEW"]'),
('Branch Supervisor', 'CHECKER', '["FORM_CREATE","FORM_SUBMIT","FORM_VIEW_BRANCH","APPROVE_TIER1","APPROVE_TIER2","QUEUE_VIEW","BULK_APPROVE"]'),
('Branch Manager', 'BRANCH_MANAGER', '["FORM_CREATE","FORM_SUBMIT","FORM_VIEW_BRANCH","APPROVE_TIER1","APPROVE_TIER2","APPROVE_TIER3","QUEUE_VIEW","BRANCH_CONFIG","DELEGATION","FORM_BUILDER","AUDIT_VIEW"]'),
('Operations Head', 'OPS_ADMIN', '["FORM_CREATE","FORM_SUBMIT","DASHBOARD_ALL","SLA_MONITOR","ESCALATION_OVERRIDE","CROSS_BRANCH","QUEUE_VIEW","FORM_BUILDER","AUDIT_VIEW"]'),
('IT Admin', 'SYSTEM_ADMIN', '["FORM_BUILDER","WORKFLOW_CONFIG","THEME_MANAGE","USER_MANAGE","ROLE_MAPPING","AUDIT_VIEW"]'),
